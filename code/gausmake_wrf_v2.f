...
c------------------------------------------------------------
     ...
     & dystrt,hrstrt,dystop,hrstop,hint,ilon,jlat,sres,r
      close(3)
10    format (//a8/a5/a8/a10/i8/i2/i8/i2/i2/i3/i3/i3/i1)
      ...
      if (sres.eq.50) then
        ...
        yname='lat2'
         ...
         print *, 'Only applicable resolutions are 50, 150 or 250'
         stop
      endif   
...
c  Assumes a file of format 'name',YYYYMM,'_regrid.nc'. 
        name='WRF_slp_R1_'
        path = '/srv/ccrc/data34/z3478332/WRF/R1/'
      else if (r.eq.2) then
        name='WRF_slp_R2_'
        path = '/srv/ccrc/data34/z3478332/WRF/R2/'
      else if (r.eq.3) then
        name='WRF_slp_R3_'
        path = '/srv/ccrc/data34/z3478332/WRF/R3/'
      else
         print *, 'Only applicable versions are R1, R2 or R3'
         stop
      endif  
