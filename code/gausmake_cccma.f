...
c------------------------------------------------------------
      ifile1= '/srv/ccrc/data41/z3444417/Data/CMIP3/CCCMA/raw/'//
     +       'psl_a7_20c3m_4_cgcm3.1_t47_1850_2000.nc'
      inet1=ncopn(ifile1,0,icode)

      ifile2= '/srv/ccrc/data41/z3444417/Data/CMIP3/CCCMA/raw/'//
     +       'psl_a7_sresa2_4_cgcm3.1_t47_2001_2100.nc'
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      subroutine xhour(iy,im,id,ih,xhours) !NOTE - NO LEAP YEARS
