...
c----------------------------------------------------------------------
      ...
      character*20 ofile1,ofile2
      integer inet1,inet2,ncopn,ncvid,utopen,icode,latv,lonv,ivar
      ...
      ilon=301
      res='0.1X0.1'
      ifile1= '/srv/ccrc/data36/z3478332/WRF/'//
     +        'WRF_topo_d01_v2.nc'
      ofile1='WRF_topo_d01_v2'
      inet1=ncopn(ifile1,0,icode)
      open(2,file=ofile1,form='unformatted') 
      call write_ausm(res,inet1,2)

      ifile2= '/srv/ccrc/data36/z3478332/WRF/'//
     +        'WRF_topo_d02_v2.nc'
      ofile2='WRF_topo_d02_v2'
      inet2=ncopn(ifile2,0,icode)
      open(3,file=ofile2,form='unformatted') 
      call write_ausm(res,inet2,3)
