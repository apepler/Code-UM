...
c------------------------------------------------------------
     ...
     & dystrt,ndays,ilon,jlat,member,path
      close(3)
10    format (//a8/a5/a8/a10/i8/i3/i3/i3/a3/a80)
...
c------------------------------------------------------------
     ...
     &,trim(name),dystrt,'_',member,'.nc'
      ...
      print *, jlat, latitude(jlat), ilon, longitude(ilon)
...
CC Write to the file that's currently open         
      x2=x/100
      latitude2=latitude(1:jlat)
      longitude2=longitude(1:ilon)
      print *, latitude2(jlat), longitude2(ilon)
      print *, x(1,1),x2(1,1)
