...
c----------------------------------------------------------------------
      ...
      instfile = 'ingausmake'
      ofile    = 'tape11'
c      path = '/g/data1/ub4/erai/netcdf/6hr/atmos/' //
c     +       'oper_an_sfc/v01/psl/'
...
c------------------------------------------------------------
     ...
     & dystrt,hrstrt,dystop,hrstop,hint,ilon,jlat,path
      close(3)
10    format (//a8/a5/a8/a10/i8/i2/i8/i2/i2/i3/i3/a250)
...
CC  Extract and unpack the needed timestep of data      
      ...
      enddo 
      x=x/400
c      print *, ny,nm,nd,start(3),work(1,1),x(1,1),maxval(x)
