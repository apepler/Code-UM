...
c----------------------------------------------------------------------
      ...
      character*100 instfile,ofile,ohead,path,name
...
c------------------------------------------------------------
      read(3,10)vtype,rtype,vunits,gtype,dystrt,hrstrt,
     & dystop,hrstop,hint,ilon,jlat,day0,path,name
      close(3)
10    format (//a8/a5/a8/a10/i8/i2/i8/i2/i2/i3/i3/i8/a100/a100)

      vname='slp0'
      xname='lon0'
      yname='lat0'

c      name='WRF_d01_slp_regrid.nc'
